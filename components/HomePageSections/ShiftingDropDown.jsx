...
const Tab = ({ children, tab, handleSetSelected, selected }) => {
    return (
        <button
            ...
            className={`flex items-center gap-1 rounded-full text-sm transition-colors ${selected === tab
...
const Content = ({ selected, dir }) => {
    return (
        <motion.div
            ...
            className="absolute left-0 top-[calc(100%_+_24px)] w-96 rounded-lg border border-neutral-100 bg-gradient-to-b from-neutral-900 via-neutral-900 to-neutral-800 p-4"
        >
            <Bridge />
...
const Nub = ({ selected }) => {
    ...
    return (
        <motion.span
            ...
            animate={{ left }}
            transition={{ duration: 0.25, ease: "easeInOut" }}
            className="absolute left-1/2 top-0 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rotate-45 rounded-tl border border-neutral-200 bg-neutral-900"
        />
    );
};
...
const Products = () => {
    return (
        <div className="canvas_dropdown ">
            {/* ************************************************************************************************************* */}
            <div className="flex canvas_dropdown_element gap-8 justify-between">
